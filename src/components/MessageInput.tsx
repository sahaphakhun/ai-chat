...
export const MessageInput: React.FC<{ onSend: (text: string) => void; disabled?: boolean }> = ({ onSend, disabled }) => {
  ...
  return (
    <div className="p-3 pb-[env(safe-area-inset-bottom)] border-t dark:border-neutral-800">
      <div className="flex gap-2">
        <textarea
          value={text}
          onChange={e => setText(e.target.value)}
          placeholder="พิมพ์ข้อความ..."
          className="flex-1 rounded border dark:border-neutral-700 p-2 h-20 sm:h-24 resize-none bg-white dark:bg-neutral-900"
        />
